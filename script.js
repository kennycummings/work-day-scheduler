...
$(document).ready(function () {
  ...
  // Set the current time with hours, minutes, and seconds
...
$('.time-block').each(function () {
  ...
  // Remove all classes and add the appropriate class based on the current hour
...
// Get user input from localStorage and set values of corresponding textarea elements
$('.time-block').each(function () {
  var timeBlockId = $(this).attr('id');
